...
public class RatingController {
	...
	@GetMapping(path = "users/{userId}/ratings/movies/{movieId}")
	...
	@PostMapping(path = "users/{userId}/ratings/movies")
	...
	@PostMapping(path = "users/{userId}/ratings/movies/{movieId}")
	...
	@GetMapping(path = "users/{userId}/ratings")
